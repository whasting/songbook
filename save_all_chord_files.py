#!/usr/bin/env python3
"""
Save ALL 25 songs as complete .txt chord files
"""
import os

os.makedirs('chord_files', exist_ok=True)

# All 25 complete songs
all_songs = {
    'I_Should_Have_Been_a_Cowboy.txt': """I Should Have Been a Cowboy - Toby Keith
Key: G | I-V-IV | No capo
============================================================
...
G   D   C   D   x4""",
    ...
    'I_Love_This_Bar.txt': """I Love This Bar - Toby Keith
Key: D | I-V-vi-IV | No capo
============================================================
...
Mmm mm - mm - mm, I just love this old bar""",
    ...
    'How_Do_You_Like_Me_Now.txt': """How Do You Like Me Now - Toby Keith
Key: G/C | I-bVII-IV (modal) | No capo
============================================================
...
F  C  G  C""",
    ...
    'Chattahoochee.txt': """Chattahoochee - Alan Jackson
Key: C | I-V-IV | No capo
============================================================
...
A lot about livin' and a little 'bout love""",
    ...
    'Gone_Country.txt': """Gone Country - Alan Jackson
Key: G | I-V-vi-IV | No capo
============================================================
...
She's gone country, here she comes""",
    ...
    'Drive_For_Daddy_Gene.txt': """Drive (For Daddy Gene) - Alan Jackson
Key: G | I-V-IV-vi | Capo 4th fret
============================================================
...
With a seventy-five Johnson with electric choke""",
    ...
    'Hey_Good_Lookin.txt': """Hey Good Lookin' - Hank Williams
Key: C | I-II-V7-IV | No capo
============================================================
...
How's about cookin' somethin' up with me?""",
    ...
    'Family_Tradition.txt': """Family Tradition - Hank Williams Jr.
Key: E | I-IV-V7 | No capo
============================================================
...
If I get stoned and sing all night long, it's a family tradition.""",
    ...
    'All_My_Exes_Live_in_Texas.txt': """All My Exes Live in Texas - George Strait
Key: A | I-V-ii-V7 | No capo
============================================================
...
And that's why I hang my hat in Tennessee""",
    ...
    'Diggin_Up_Bones.txt': """Diggin' Up Bones - Randy Travis
Key: C | I-V-IV | No capo
============================================================
...
[Lead Solo for two chorus lines]
    ...
    'Boot_Scootin_Boogie.txt': """Boot Scootin' Boogie - Brooks & Dunn
Key: E | I-IV-V | No capo
============================================================
...
Oh, get down, turn around, go to town boot, scootin' boogie""",
    ...
    'Friends_in_Low_Places.txt': """Friends in Low Places - Garth Brooks
Key: A | I-#idim-ii-V | No capo
============================================================
...
In low places""",
    ...
    'A_Country_Boy_Can_Survive.txt': """A Country Boy Can Survive - Hank Williams Jr.
Key: D | I-v-IV (modal) | No capo
============================================================
...
(Repeat and Fade)""",
    ...
    'Pickup_Man.txt': """Pickup Man - Joe Diffie
Key: G | I-IV-V7 | No capo
============================================================
...
G""",
    ...
    'Travelin_Soldier.txt': """Travelin' Soldier - The Chicks (Dixie Chicks)
Key: G | I-IV-bVII-vi-V | Capo 2nd fret
============================================================
...
7.  Crying all alone under the stands
    ...
    'Wide_Open_Spaces.txt': """Wide Open Spaces - The Chicks (Dixie Chicks)
Key: D | I-IV-ii-V | Capo 2nd fret
============================================================
...
D Em G A D Em G A D""",
    ...
    'Cowboy_Take_Me_Away.txt': """Cowboy Take Me Away - The Chicks (Dixie Chicks)
Key: F/Am | i-III-V-VII (aeolian) | Capo 6th fret
============================================================
...
# Save all songs
for filename, content in all_songs.items():
    filepath = f'chord_files/{filename}'
    with open(filepath, 'w') as f:
        f.write(content)
    print(f"✅ Saved: {filepath}")

print(f"\n✅ COMPLETE! All {len(all_songs)} songs saved as .txt files")
print("All songs now have complete, untruncated chord charts!")
